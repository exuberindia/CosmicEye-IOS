//
//  DateOverviewThirdSheetVC.swift
//  cosmiceye
//
...
class DateOverviewThirdSheetVC: UIViewController, FSCalendarDataSource, FSCalendarDelegate, FSCalendarDelegateAppearance {
    ...
    static func instantiate() -> DateOverviewThirdSheetVC {
        return UIStoryboard(name: "BottomSheet", bundle: nil).instantiateViewController(withIdentifier: "DateOverviewThirdSheetScreen") as! DateOverviewThirdSheetVC
    }
