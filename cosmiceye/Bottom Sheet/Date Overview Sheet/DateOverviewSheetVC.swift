//
//  DateOverviewSheetVC.swift
//  cosmiceye
//
//  Created by Rachin Allakkot on 31/03/20.
...
class DateOverviewSheetVC: UIViewController, FSCalendarDataSource, FSCalendarDelegate, FSCalendarDelegateAppearance {
    ...
    static func instantiate() -> DateOverviewSheetVC {
        return UIStoryboard(name: "BottomSheet", bundle: nil).instantiateViewController(withIdentifier: "DateOverviewSheetScreen") as! DateOverviewSheetVC
    }
