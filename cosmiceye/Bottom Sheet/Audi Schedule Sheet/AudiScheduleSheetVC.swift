...
class AudiScheduleSheetVC: UIViewController {

    @IBOutlet var audiScheduleSheetTable: UITableView!
    ...
    override func viewDidLoad() {
        ...
        self.audiScheduleSheetTable.delegate = self
        self.audiScheduleSheetTable.dataSource = self
               
        self.sheetViewController?.handleScrollView(self.audiScheduleSheetTable)
        
    }
    
    static func instantiate() -> AudiScheduleSheetVC {
        return UIStoryboard(name: "BottomSheet", bundle: nil).instantiateViewController(withIdentifier: "AudiScheduleSheetScreen") as! AudiScheduleSheetVC
    }
    ...
    @objc private func contentClickFunction(sender:UITapGestureRecognizer) {
        ...
        //Reloading Table
        self.audiScheduleSheetTable.beginUpdates()
        self.audiScheduleSheetTable.endUpdates()
        self.audiScheduleSheetTable.layer.removeAllAnimations()
    }
    

}

extension AudiScheduleSheetVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let audiCell = tableView.dequeueReusableCell(withIdentifier: "AudiScheduleSheetCell", for: indexPath) as! AudiScheduleSheetCell
