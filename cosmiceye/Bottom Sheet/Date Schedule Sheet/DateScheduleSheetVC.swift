...
class DateScheduleSheetVC: UIViewController, FSCalendarDataSource, FSCalendarDelegate, FSCalendarDelegateAppearance {
    ...
    override func viewDidLoad() {
        ...
        if isStarDateSelected
        {
           ...
           dateSelectCalendar.currentPage = selectedStartDate
    ...
    static func instantiate() -> DateScheduleSheetVC {
        return UIStoryboard(name: "BottomSheet", bundle: nil).instantiateViewController(withIdentifier: "DateScheduleSheetScreen") as! DateScheduleSheetVC
    }
    ...
    @IBAction func todayButtonClickFunction(_ sender: Any) {
        ...
        if isTodaySelected
        {
            ...
            applyButton.backgroundColor = UIColor(red: 81/255, green: 45/255, blue: 168/255, alpha: 0.2)
        ...
        else
        {
            ...
            applyButton.backgroundColor = UIColor(red: 81/255, green: 45/255, blue: 168/255, alpha: 1.0)
            ...
            self.dateSelectCalendar.currentPage = endDate!
    ...
    func calendar(_ calendar: FSCalendar, didSelect date: Date, at monthPosition: FSCalendarMonthPosition) {
        ...
        self.dateSelectCalendar.currentPage = selectedStartDate
